    ...
    <div className="bg-[#FAFAFA] min-h-screen pt-20">
      ...
      <div className="border-b border-[#E5E5E5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-[#0A0A0A] mb-3">
            Privacy Policy
          </h1>
              ...
              <ul className="space-y-1.5">
                {TOC.map(({ id, label }) => (
                  <li key={id}>
                    <a
                      href={`#${id}`}
                      className="block text-sm text-[#6B7280] hover:text-[#0A0A0A] transition-colors py-0.5"
                    >
                      {label}
                    </a>
                  </li>
          ...
          <div className="flex-1 max-w-3xl">
            <div className="prose-custom space-y-12">
              ...
              <section id="information-we-collect">
                ...
                <h3 className="text-base font-medium text-[#0A0A0A] mt-6 mb-2">
                  Account Information
                </h3>
              ...
              <section id="how-we-use-your-data">
                ...
                <ul className="space-y-2.5">
                  {[
                    ...
                    <li key={title} className="text-sm text-[#6B7280] leading-relaxed">
                      <span className="font-medium text-[#0A0A0A]">{title}:</span> {desc}
                    </li>
                  ))}
                </ul>
              </section>
              ...
              <section id="fleet-data-isolation">
                ...
                <div className="rounded-xl border border-[#F5C518]/30 bg-[#F5C518]/5 p-5 mb-4">
              ...
              <section id="data-sharing">
                ...
                <ul className="space-y-2.5 text-sm text-[#6B7280] leading-relaxed">
                  <li>
                    <span className="font-medium text-[#0A0A0A]">With your explicit consent:</span>{' '}
                    We will share data with third parties only when you have given explicit written
                    authorization.
                  </li>
                  <li>
                    <span className="font-medium text-[#0A0A0A]">Payment processing:</span>{' '}
                  ...
                  <li>
                    <span className="font-medium text-[#0A0A0A]">Infrastructure providers:</span>{' '}
                  ...
                  <li>
                    <span className="font-medium text-[#0A0A0A]">Legal requirements:</span>{' '}
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-[#F5F5F5]">
                        <th className="text-left py-3 px-4 text-xs font-semibold text-[#0A0A0A] uppercase tracking-wider">
                          Tier
                        </th>
                        <th className="text-left py-3 px-4 text-xs font-semibold text-[#0A0A0A] uppercase tracking-wider">
                          Data Retention
                    ...
                    <tbody className="divide-y divide-[#E5E5E5]">
                      <tr>
                        <td className="py-3 px-4 text-[#0A0A0A] font-medium">Free</td>
                        <td className="py-3 px-4 text-[#6B7280]">30 days</td>
                        <td className="py-3 px-4 text-[#6B7280]">Deleted after 30 days</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 text-[#0A0A0A] font-medium">Pro</td>
                        <td className="py-3 px-4 text-[#6B7280]">1 year</td>
                        <td className="py-3 px-4 text-[#6B7280]">Export available for 30 days, then deleted</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 text-[#0A0A0A] font-medium">Enterprise</td>
                        <td className="py-3 px-4 text-[#6B7280]">Unlimited (per contract)</td>
                        <td className="py-3 px-4 text-[#6B7280]">Export available for 30 days, then deleted per agreement</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <section id="your-rights">
                ...
                <ul className="space-y-2.5 text-sm text-[#6B7280] leading-relaxed">
                  <li>
                    <span className="font-medium text-[#0A0A0A]">Right of access:</span>{' '}
                    Request a copy of the personal data we hold about you and your organization.
                  </li>
                  <li>
                    <span className="font-medium text-[#0A0A0A]">Right to correction:</span>{' '}
                    Request correction of inaccurate or incomplete personal data.
                  </li>
                  <li>
                    <span className="font-medium text-[#0A0A0A]">Right to deletion:</span>{' '}
                    Request deletion of your personal data, subject to legal retention
                    requirements.
                  </li>
                  <li>
                    <span className="font-medium text-[#0A0A0A]">Right to data portability:</span>{' '}
                    Request an export of your data in a machine-readable format (JSON or CSV).
                  </li>
                  <li>
                    <span className="font-medium text-[#0A0A0A]">Right to restrict processing:</span>{' '}
                    Request that we limit the processing of your data in certain circumstances.
                  </li>
                  <li>
                    <span className="font-medium text-[#0A0A0A]">Right to object:</span>{' '}
                    Object to data processing based on legitimate interests or for direct
                    marketing.
                  </li>
                  <li>
                    <span className="font-medium text-[#0A0A0A]">CCPA rights:</span>{' '}
              ...
              <section id="cookies">
                ...
                <div className="rounded-xl border border-[#E5E5E5] overflow-hidden">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-[#E5E5E5]">
                      <tr>
                        <td className="py-3 px-4 text-[#0A0A0A] font-medium font-mono text-xs">
                          session_token
                        </td>
                        <td className="py-3 px-4 text-[#6B7280]">Authentication session management</td>
                        <td className="py-3 px-4 text-[#6B7280]">8 hours</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 text-[#0A0A0A] font-medium font-mono text-xs">
                          preferences
                        </td>
                        <td className="py-3 px-4 text-[#6B7280]">Theme, dashboard layout, and display settings</td>
                        <td className="py-3 px-4 text-[#6B7280]">1 year</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 text-[#0A0A0A] font-medium font-mono text-xs">
                        ...
                        <td className="py-3 px-4 text-[#6B7280]">Anonymous usage analytics (first-party only)</td>
                        <td className="py-3 px-4 text-[#6B7280]">30 days</td>
                      </tr>
                    </tbody>
                  </table>
