      ...
      <div className="border-b border-[#E5E5E5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <div className="flex items-center gap-2 mt-5 text-xs text-[#9CA3AF]">
            <Scale className="size-3.5 text-[#F5C518]" />
          ...
          <div className="flex-1 max-w-3xl">
            <div className="space-y-12">
              ...
              <section id="service-description">
                ...
                <ul className="space-y-2 text-sm text-[#6B7280] leading-relaxed ml-4 list-disc">
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-[#E5E5E5]">
                      <tr>
                        ...
                        <td className="py-3 px-4 text-[#6B7280]">$0/month</td>
                        <td className="py-3 px-4 text-[#6B7280]">2 compressors, 1-hour data window</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 text-[#0A0A0A] font-medium">Pro</td>
                        <td className="py-3 px-4 text-[#6B7280]">$49/month</td>
                        <td className="py-3 px-4 text-[#6B7280]">20 compressors, all data windows</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 text-[#0A0A0A] font-medium">Enterprise</td>
                        <td className="py-3 px-4 text-[#6B7280]">$199/month</td>
                        <td className="py-3 px-4 text-[#6B7280]">Unlimited compressors, ML predictions, priority support</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <section id="sla">
                ...
                <div className="rounded-xl border border-[#E5E5E5] overflow-hidden mb-4">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-[#E5E5E5]">
                      <tr>
                        <td className="py-3 px-4 text-[#6B7280]">99.0% - 99.9%</td>
                        <td className="py-3 px-4 text-[#6B7280]">10% of monthly subscription</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 text-[#6B7280]">95.0% - 99.0%</td>
                        <td className="py-3 px-4 text-[#6B7280]">25% of monthly subscription</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 text-[#6B7280]">Below 95.0%</td>
                        <td className="py-3 px-4 text-[#6B7280]">50% of monthly subscription</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
