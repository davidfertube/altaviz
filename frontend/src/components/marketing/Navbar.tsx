          ...
          <div className="lg:hidden bg-white/95 backdrop-blur-xl border-t border-[#E5E5E5] max-h-[80vh] overflow-y-auto">
            <div className="px-4 py-4 space-y-1">
              ...
              <div className="pt-3 border-t border-[#E5E5E5] space-y-2">
                ...
                <button
                  onClick={() => { closeMobile(); setLeadOpen(true); }}
                  className="block w-full text-sm font-semibold text-center text-[#0A0A0A] bg-[#F5C518] hover:bg-[#FFD84D] transition-colors px-8 py-3 rounded-full"
                >
                  Get Started
                </button>
              </div>
